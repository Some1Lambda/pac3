...
registerprivilege("pac3.load", "Load a PAC3", "Allows the user load a PAC3", { client = { default = 1 } })
registerprivilege("pac3.clear", "Clear your PAC3", "Allows the user to clear the PAC3", { client = { default = 1 } })
